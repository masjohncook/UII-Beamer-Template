...
\begin{chapter}[images/uic_seo.jpg]{nycublue}{Personalization}
...
\begin{itemize}
    \item We are currently using \testcolor{nycublue} color for our footer.
...
\begin{chapter}[images/uic_seo.jpg]{nycublue}{Title goes here}
...
\begin{chapter}[images/dept_ece.png]{nycublue}{Title goes here}
\textit{Subtitle goes here}
\end{chapter}

\begin{chapter}[images/dept_cs_white.png]{nycublue}{Title goes here}
\textit{Subtitle goes here}
\end{chapter}
